...
export const quests: QuestRecord[] = [
  ...
  },
  {
    ...
    name: "[일일] 길드는 자선단체가 아니다", startLocationId: "oquilla-eye", giverId: "oquilla-soldier",
    ...
    note: "오킬루아의 눈 병사에게 수령",
  },
  {
    id: "self-defense", codexQuestId: "3707/7/", period: "daily",
    name: "[일일] 제 몸 하나는 스스로 지켜야", startLocationId: "oquilla-eye", giverId: "oquilla-soldier",
  ...
  },
  {
    ...
    name: "[일일] 너도 좋고, 나도 좋고", startLocationId: "oquilla-eye", giverId: "oquilla-soldier",
